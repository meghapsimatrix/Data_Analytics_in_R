...
1.  Run the following code to load the data. View the codebook and other information on the on the data [here](https://rfordatascience.github.io/tidytuesday/data/2025/2025-05-06/readme.html).
