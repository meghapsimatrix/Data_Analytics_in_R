...
![](images/motivation.png){fig-alt="A motivational poster with quote from Kieran Healy saying \"You should look at your data.\" The quote is from Data Visualization: A Practical Introduction, 2018.o"}
:::
...
## Example Dataset: Capital Bike Sharing Data {style=".smaller"}

Source: [UCI Repository](https://archive.ics.uci.edu/dataset/275/bike+sharing+dataset)
...
::: columns
::: {.column width="50%"}
[![](images/Picture1.png){fig-alt="Screenshot from ggplot2 website showing different layers. There is an illustration of squares on top of each other representing the following layers from bottom to top: data, mapping, layers, scales, facets, coordinates, themes."}](https://ggplot2.tidyverse.org/articles/ggplot2.html)
:::
...
# Introducing More Variables {.inverse}
