...
![](images/mj.jpeg){fig-alt="Photo of one of the instructors Megha Joshi"}

## Expectations

::: {.columns style=".smaller"}
::: {.column width="50%"}
[![](images/r4ds.jpg){fig-alt="Cover of the R for Data Science Book Second Edition" width="382"}](https://r4ds.hadley.nz/)
:::
...
-   Recommended readings
    ...
    -   For each class, we will list out relevant chapters
...
::: columns
::: {.column width="50%"}
![](images/RStudio.png){fig-alt="Logo for R Studio"}
:::

::: {.column width="50%"}
-   Download [R](https://www.r-project.org/)

-   Download [R Studio](https://posit.co/downloads/) / Download [Positron](https://positron.posit.co/download)

-   Download [Quarto](https://quarto.org/)
:::
:::

## R Studio - R Projects and Relative Path {.smaller}
...
::: columns
::: {.column width="30%"}
[![](images/code_check.png){fig-alt="Hex sticker for Code Check Club"}](https://debruine.github.io/project/code-check/)
:::
...
::: columns
::: {.column width="50%"}
![](images/quarto.png){fig-alt="Screenshot from quarto's website showing it can be used to create dashboards, websites, books, presentations etc." width="723"}
:::
