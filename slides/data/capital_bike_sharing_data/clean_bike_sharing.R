...
capital_bike_sharing <- read_csv("slides/data/capital_bike_sharing_data/capital_bike_sharing.csv")
...
save(bike_sharing_dat, file = "slides/data/capital_bike_sharing_data/bike_sharing_dat.RData")
